...
insert into t_recognize_reg (keyword, contains, excludes) values ('平板电脑', '平板', '');
...
insert into t_recognize_reg (keyword, contains, excludes) values ('涉赌', '赌博, 扑克, 麻将, 六合彩, 牌九', '');
...
insert into t_recognize_reg (keyword, contains, excludes) values ('老年人', '老人, 老年, 老年人', '');
